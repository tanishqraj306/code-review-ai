...
import { ArrowLeft, Calendar, GitPullRequest, ExternalLink } from "lucide-react";
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold flex items-center gap-3">
            ...
            >
              {review.repo_name}
              <span className="text-muted-foreground text-2xl ml-2">#{review.pr_number}</span>
          ...
          <div className="prose dark:prose-invert max-w-none bg-muted/30 p-6 rounded-md text-sm leading-relaxed">
            <ReactMarkdown
              components={{
                ...
                code: ({ node, ...props }) => <code className="bg-black/10 dark:bg-white/10 px-1 py-0.5 rounded font-mono text-xs" {...props} />,
